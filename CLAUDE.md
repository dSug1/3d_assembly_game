...
✅ Green: TypeScript + Babylon + Vite, **1198 golden vectors passing** — ⚠ MEASURED 2026-09-25; the
...
⭐ **FACE › *PioneerFaceCursor drag on/off*** (`pioneerCursorDrag`, ships `1`): at `0` nothing grabs the ring.
