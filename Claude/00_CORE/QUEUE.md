...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **615 golden vectors,
all passing** (37 → 632 → **574** — ⭐ 58 DELETED with the roll channel — → 615). ✅ The engine boundary is enforced by a test.
