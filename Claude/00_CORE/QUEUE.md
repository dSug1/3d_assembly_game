...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **436 golden vectors,
all passing** (37 → 436). ✅ The engine boundary is enforced by a test.
