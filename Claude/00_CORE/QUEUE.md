...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **397 golden vectors,
all passing** (37 → 397). ✅ The engine boundary is enforced by a test.
