...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **1167 golden vectors,
all passing** (37 → … → **1167**; ⭐ each DROP has a `D` row). ⛔⛔ **A COUNT RESTATED IN TWO PLACES GOES STALE.**
