...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **1159 golden vectors,
all passing** (37 → … → **1159**; ⭐ each DROP has a `D` row). ⛔⛔ **A COUNT RESTATED IN TWO PLACES GOES STALE.**
