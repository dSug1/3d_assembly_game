...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **1218 golden vectors,
all passing** (37 → … → **1218**; ⭐ each DROP has a `D` row). ⛔⛔ **A COUNT RESTATED IN TWO PLACES GOES STALE.**
