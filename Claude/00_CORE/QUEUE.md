...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **357 golden vectors,
all passing** (37 → 357). ✅ The engine boundary is enforced by a test.
