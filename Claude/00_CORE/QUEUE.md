...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **1088 golden vectors,
all passing** (37 → … → 1083 → 1087 → **1088**; ⭐ the DROPS are `D54`, the roll channel and forks A and B). ⛔⛔ **A COUNT RESTATED IN TWO PLACES GOES STALE** — `974`, then `978`: *amend the ledger, never a bare number written somewhere else.*
