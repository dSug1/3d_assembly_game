...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **1215 golden vectors,
all passing** (37 → … → **1215**; ⭐ each DROP has a `D` row). ⛔⛔ **A COUNT RESTATED IN TWO PLACES GOES STALE.**
