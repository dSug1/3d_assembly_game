...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **372 golden vectors,
all passing** (37 → 372). ✅ The engine boundary is enforced by a test.
