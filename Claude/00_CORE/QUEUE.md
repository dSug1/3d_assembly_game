...
✅ TypeScript + Babylon + Vite; `npm run verify` = typecheck + **568 golden vectors,
all passing** (37 → 632 → **574** — ⭐ 58 DELETED with the roll channel — → 619 → **568**, ⭐ the drop being forks A and B deleted). ✅ The engine boundary is enforced by a test.
