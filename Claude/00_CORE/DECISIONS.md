...
| `D102` | ⭐⭐ **A SEATED ASSEMBLY DRIVES AS ONE BODY; THE SNAP IS A MAGNET; THE OFFSET IS 15 mm** | 2026-09-26 | A press on any member drives the root (stops below a frozen Pioneer); the gizmo anchors on the touched face; `snapMs` 60 on `u²`; 15 mm again → §11.13.1 |
