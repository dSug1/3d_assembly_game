...
| `D96` | ⭐⭐ **A PIONEERFACECURSOR PER ALIGNMENT** | 2026-09-25 | An amber ring at the PioneerFace centre, facing the screen; one per follower couple, disposed with it. Dragged on the face's surface, bounded by its edges — ⛔ **drag ships OFF** (FACE menu) → §11.10, defect 71 |
