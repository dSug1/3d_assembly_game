...
| `D99` | ⭐⭐⭐ **THE SCORE: TOUCHPOINT EPISODES AGAINST A SOLVED OPTIMUM, AND ELAPSED TIME** | 2026-09-26 | One episode = press → release. Fewer wins; equal to the optimum wins the bonus; time punishes the sloppy drag. ⛔ Specified, not built → `20_GAME_RULES/spec/SCORE.md` |
