...
| `D100` | ⭐⭐ **THE SNAP IS AUTOMATIC AND A SEATED PIONEER CARRIES ITS FOLLOWERS; UNSNAP IS AN EPISODE** | 2026-09-26 | Conditions (distance, cone angle, …) still the owner's. ⛔ Answers `3D2`'s blocker: no gesture; the seat is `3D1`'s tree |
